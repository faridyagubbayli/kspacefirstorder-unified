...
/**
 * @brief Transpose a real 3D matrix in the X-Y direction. It is done
 * out-of-place.
 *
...
void trasposeReal3DMatrixXY(float* outputMatrix, const float* inputMatrix,
                            const dim3& dimSizes);

/**
 * @brief Transpose a real 3D matrix in the X-Z direction. It is done
 * out-of-place.
 *
 * @tparam      padding      - Which matrices are padded.
 *
 ...
 */
template <TransposePadding padding>
void trasposeReal3DMatrixXZ(float* outputMatrix, const float* inputMatrix,
                            const dim3& dimSizes);
}  // namespace TransposeCudaKernels
//----------------------------------------------------------------------------------------------------------------------
