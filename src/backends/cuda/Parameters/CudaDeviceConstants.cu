 ...
 *
 * @brief     The implementation file for the class for storing constants
 * residing in CUDA constant memory.
 *
...
__host__ void CudaDeviceConstants::copyToDevice() {
  cudaCheckErrors(cudaMemcpyToSymbol(cudaDeviceConstants, this,
                                     sizeof(CudaDeviceConstants)));
}  // end of copyToDevice
//----------------------------------------------------------------------------------------------------------------------
