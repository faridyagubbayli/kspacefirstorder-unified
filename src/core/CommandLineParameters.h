 ...
 * first
 * checks the `OMP_NUM_THREADS` variable. If it is not defined, the code uses
the number of logical processor cores.
 * If the system support hyper-threading, it is recommended to use only half the
number threads to prevent cache
...
class CommandLineParameters {
 ...
 private:
   ...
   * @return The number of threads set by the OMP_NUM_THREADS environmental
   * variable if set, or the number of logical processor cores.
   */
