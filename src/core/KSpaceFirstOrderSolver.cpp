...
#include "KSpaceFirstOrderSolver.h"

#ifdef USE_CUDA
#include <backends/cuda/MatrixClasses/CufftComplexMatrix.h>
#else
#include <backends/openmp/MatrixClasses/FftwComplexMatrix.h>
#endif
#include "Logger.h"
 ...
 */
KSpaceFirstOrderSolver::ComputeMainLoopImp
    KSpaceFirstOrderSolver::sComputeMainLoopImp{
        //  3D cases          SD  rho0   bOnA   c0     alpha
        {std::make_tuple(SD::k3D, true, true, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, true, true,
                                                  true>},
        {std::make_tuple(SD::k3D, true, true, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, true, true,
                                                  false>},
        {std::make_tuple(SD::k3D, true, true, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, true, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k3D, true, false, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, false, true,
                                                  true>},
        {std::make_tuple(SD::k3D, true, false, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, false, true,
                                                  false>},
        {std::make_tuple(SD::k3D, true, false, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, true, false, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k3D, false, true, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, true, true,
                                                  true>},
        {std::make_tuple(SD::k3D, false, true, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, true, true,
                                                  false>},
        {std::make_tuple(SD::k3D, false, true, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, true, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k3D, false, false, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, false, true,
                                                  true>},
        {std::make_tuple(SD::k3D, false, false, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, false, true,
                                                  false>},
        {std::make_tuple(SD::k3D, false, false, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k3D, false, false, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k2D, true, true, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, true, true,
                                                  true>},
        {std::make_tuple(SD::k2D, true, true, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, true, true,
                                                  false>},
        {std::make_tuple(SD::k2D, true, true, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, true, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k2D, true, false, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, false, true,
                                                  true>},
        {std::make_tuple(SD::k2D, true, false, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, false, true,
                                                  false>},
        {std::make_tuple(SD::k2D, true, false, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, true, false, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k2D, false, true, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, true, true,
                                                  true>},
        {std::make_tuple(SD::k2D, false, true, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, true, true,
                                                  false>},
        {std::make_tuple(SD::k2D, false, true, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, true, false,
                                                  false>},
        ...
        {std::make_tuple(SD::k2D, false, false, true, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, false, true,
                                                  true>},
        {std::make_tuple(SD::k2D, false, false, true, false),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, false, true,
                                                  false>},
        {std::make_tuple(SD::k2D, false, false, false, true),
         &KSpaceFirstOrderSolver::computeMainLoop<SD::k2D, false, false, false,
                                                  false>},
...
/**
 * The method allocates the matrix container, creates all matrices and creates
 * all output streams. The memory for output stream is not allocated since the
 * size of the masks is not known.
 */
...
/**
 * Load data from the input file provided by the Parameter class and create the
 * output time series streams. If checkpointing is enabled, this may include
 * reading data from checkpoint and output files.
 */
void KSpaceFirstOrderSolver::loadInputData() {
  ...
  // Get handles
  Hdf5File& inputFile =
      mParameters.getInputFile();  // file is opened (in Parameters)
  ...
  // Recover from the checkpoint if it is enabled and the checkpoint file
  // exists.
  bool recoverFromCheckpoint =
      (mParameters.isCheckpointEnabled() &&
  ...
  if (recoverFromCheckpoint) {
    ...
    // Create the steams, link them with the sampled matrices, however DO NOT
    // allocate memory!
  ...
  Logger::log(Logger::LogLevel::kBasic, kOutFmtElapsedTime,
              mDataLoadTime.getElapsedTime());
...
void KSpaceFirstOrderSolver::compute() {
  ...
  try {
    ...
    Logger::errorAndTerminate(
        Logger::wordWrapString(e.what(), kErrFmtPathDelimiters, 9));
  }
  ...
  try {
    ...
    sComputeMainLoopImp[std::make_tuple(
        mParameters.getSimulationDimension(), mParameters.getRho0ScalarFlag(),
        mParameters.getBOnAScalarFlag(), mParameters.getC0ScalarFlag(),
  ...
  try {
    if (isCheckpointInterruption()) {  // Checkpoint
      ...
      Logger::log(Logger::LogLevel::kBasic, kOutFmtCheckpointCompletedTimeSteps,
      ...
      // If checkpointing is enabled and the checkpoint file already exists,
      // delete it
...
size_t KSpaceFirstOrderSolver::getFileUsage() {
  ...
  const size_t sensorMaskSize =
      (mParameters.getSensorMaskType() == Parameters::SensorMaskType::kIndex)
  ...
  const size_t sampledSteps =
      mParameters.getNt() - mParameters.getSamplingStartTimeIndex();
...
void KSpaceFirstOrderSolver::printFullCodeNameAndLicense() const {
  Logger::log(Logger::LogLevel::kBasic, kOutFmtBuildNoDataTime, 10, 11,
              __DATE__, 8, 8, __TIME__);

  if (mParameters.getGitHash() != "") {
    Logger::log(Logger::LogLevel::kBasic, kOutFmtVersionGitHash,
                mParameters.getGitHash().c_str());
  }
  Logger::log(Logger::LogLevel::kBasic, kOutFmtSeparator);
...
// Compiler detections
  ...
  // CPU detection
  Logger::log(Logger::LogLevel::kBasic, kOutFmtProcessorNameLeft,
              mParameters.getProcessorName().c_str());
...
void KSpaceFirstOrderSolver::checkOutputFile() {
  ...
  if (fileHeader.getFileType() != Hdf5FileHeader::FileType::kOutput) {
    throw ios::failure(Logger::formatMessage(
        kErrFmtBadOutputFileFormat, mParameters.getOutputFileName().c_str()));
  }

  // Check file version
  if (!fileHeader.checkFileVersion()) {
    throw ios::failure(Logger::formatMessage(
        kErrFmtBadFileVersion, fileHeader.getFileVersionName().c_str(),
  ...
  outputFile.readScalarValue(outputFile.getRootGroup(),
                             mParameters.getNxHdf5Name(), outputDimSizes.nx);
  outputFile.readScalarValue(outputFile.getRootGroup(),
                             mParameters.getNyHdf5Name(), outputDimSizes.ny);
  outputFile.readScalarValue(outputFile.getRootGroup(),
                             mParameters.getNzHdf5Name(), outputDimSizes.nz);

  if (mParameters.getFullDimensionSizes() != outputDimSizes) {
    throw ios::failure(Logger::formatMessage(
        kErrFmtOutputDimensionsMismatch, outputDimSizes.nx, outputDimSizes.ny,
        outputDimSizes.nz, mParameters.getFullDimensionSizes().nx,
...
void KSpaceFirstOrderSolver::checkCheckpointFile() {
  ...
  if (fileHeader.getFileType() != Hdf5FileHeader::FileType::kCheckpoint) {
    throw ios::failure(
        Logger::formatMessage(kErrFmtBadCheckpointFileFormat,
  ...
  if (mParameters.getFullDimensionSizes() != checkpointDimSizes) {
    throw ios::failure(Logger::formatMessage(
        kErrFmtCheckpointDimensionsMismatch, checkpointDimSizes.nx,
        checkpointDimSizes.ny, checkpointDimSizes.nz,
...
void KSpaceFirstOrderSolver::readElapsedTimeFromOutputFile() {
  double totalTime, dataLoadTime, preProcessingTime, simulationTime,
      postProcessingTime;

  // Get execution times stored in the output file header
  mParameters.getFileHeader().getExecutionTimes(
      totalTime, dataLoadTime, preProcessingTime, simulationTime,
      postProcessingTime);
...
// Initialization of FFTW library
  ...
  // Shall we recover from previous state - if checkpointing is enabled and the
...
// If the GCC compiler with FFTW is used, try to import wisdom
  ...
  if (recoverFromPrevState) {
    ...
    // Import FFTW wisdom
    try {
      // Try to find the wisdom in the file that has the same name as the
      // checkpoint file (different extension)
  ...
  if (mParameters.isSimulationAS()) {  // Axisymmetric coordinates, create R2R
                                       // transforms in y direction, and R2C and
                                       // C2R in x direction.
  ...
  } else {  // Normal coordinates, create ND R2C and CR transforms.
...
void KSpaceFirstOrderSolver::preProcessing() {
  ...
  // Compute dt / rho0_sg...
  if (!mParameters.getRho0ScalarFlag()) {  // Non-uniform grid cannot be
                                           // pre-calculated :-(
    // rho is a matrix
  ...
  if (mParameters.isSimulationAS()) {  // Axisymmetric medium
  ...
  if (((mParameters.getVelocitySourceMode() ==
        Parameters::SourceMode::kAdditive) ||
       (mParameters.getPressureSourceMode() ==
        Parameters::SourceMode::kAdditive)) &&
...
void KSpaceFirstOrderSolver::computeMainLoop() {
  mActPercent = 0;
  // Set the actual progress percentage to correspond the time index after
  // recovery
  ...
  while ((mParameters.getTimeIndex() < mParameters.getNt()) &&
    ...
    if (mParameters.getTransducerSourceFlag() > timeIndex) {
      // Transducer source is added only to the x component of the particle
      // velocity
      addTransducerSource();
    }
    ...
    computePressure<simulationDimension, rho0ScalarFlag, bOnAScalarFlag,
...
void KSpaceFirstOrderSolver::writeOutputDataInfo() {
  ...
  mParameters.getOutputFile().writeScalarValue(
      mParameters.getOutputFile().getRootGroup(),
      mParameters.getTimeIndexHdf5Name(), mParameters.getTimeIndex());
...
void KSpaceFirstOrderSolver::writeCheckpointData() {
  ...
  // Checkpoint output streams only if necessary (t_index > start_index), we're
  // here one step ahead!
  if (mParameters.getTimeIndex() > mParameters.getSamplingStartTimeIndex()) {
...
void KSpaceFirstOrderSolver::printStatistics() {
  ...
  if (timeIndex > (mActPercent * nt * 0.01f)) {
    ...
    const double elTimeWithLegs =
        mIterationTime.getElapsedTime() +
        mSimulationTime.getElapsedTimeOverPreviousLegs();
    const double toGo =
        ((elTimeWithLegs / double((timeIndex + 1)) * nt)) - elTimeWithLegs;
    ...
    Logger::log(Logger::LogLevel::kBasic, kOutFmtSimulationProgress,
                size_t(((timeIndex) / (nt * 0.01f))), '%', elTime, toGo,
...
void KSpaceFirstOrderSolver::computePressureGradient() {
  ...
  const float divider =
      1.0f / float(mParameters.getFullDimensionSizes().nElements());
  ...
  const FloatComplex* ddzKShiftPos =
      getComplexData(MI::kDdzKShiftPos, simulationDimension == SD::k3D);
  ...
  FloatComplex* ifftZ =
      getComplexData(MI::kTempFftwZ, simulationDimension == SD::k3D);
...
void KSpaceFirstOrderSolver::computePressureGradientAS() {
  ...
  // DCT and DST of type 2,3,4 uses scaling factor 2 * Ny, the FFT adds Nx,
  // yielding 2 * Ny * Nx
  const float divider =
      1.0f / (2.0f * float(mParameters.getFullDimensionSizes().nElements()));
  ...
  getTemp1FftwRealND().computeForwardR2RFft1DY(TK::kDct3,
                                               getRealMatrix(MI::kP));
...
/**
 * Compute new values of acoustic velocity in all used dimensions (UxSgx, UySgy,
 * UzSgz).
 */
...
void KSpaceFirstOrderSolver::computeVelocityUniform() {
  ...
  const float dtRho0SgxScalar =
      (rho0ScalarFlag) ? mParameters.getDtRho0SgxScalar() : 0.0f;
  const float dtRho0SgyScalar =
      (rho0ScalarFlag) ? mParameters.getDtRho0SgyScalar() : 0.0f;

  const float* dtRho0SgxMatrix =
      (rho0ScalarFlag) ? nullptr : getRealData(MI::kDtRho0Sgx);
  const float* dtRho0SgyMatrix =
      (rho0ScalarFlag) ? nullptr : getRealData(MI::kDtRho0Sgy);
...
#pragma omp simd
      for (size_t x = 0; x < dimensionSizes.nx; x++) {
        ...
        const float dtRho0Sgx =
            (rho0ScalarFlag) ? dtRho0SgxScalar : dtRho0SgxMatrix[i];
...
#pragma omp simd
      for (size_t x = 0; x < dimensionSizes.nx; x++) {
        ...
        const float dtRho0Sgy =
            (rho0ScalarFlag) ? dtRho0SgyScalar : dtRho0SgyMatrix[i];
  ...
  if (simulationDimension == SD::k3D) {
    const float dtRho0SgzScalar =
        (rho0ScalarFlag) ? mParameters.getDtRho0SgzScalar() : 0.0f;
    const float* dtRho0SgzMatrix =
        (rho0ScalarFlag) ? nullptr : getRealData(MI::kDtRho0Sgz);
...
#pragma omp simd
        for (size_t x = 0; x < dimensionSizes.nx; x++) {
          ...
          const float dtRho0Sgz =
              (rho0ScalarFlag) ? dtRho0SgzScalar : dtRho0SgzMatrix[i];
...
void KSpaceFirstOrderSolver::computeVelocityHomogeneousNonuniform() {
  ...
  const float dtRho0Sgz = (simulationDimension == SD::k3D)
  ...
  const float* dzudznSgz =
      getRealData(MI::kDzudznSgz, simulationDimension == SD::k3D);

  const float* ifftX = getRealData(MI::kTemp1RealND);
  const float* ifftY = getRealData(MI::kTemp2RealND);
  const float* ifftZ =
      getRealData(MI::kTemp3RealND, simulationDimension == SD::k3D);
...
#pragma omp simd
      for (size_t x = 0; x < dimensionSizes.nx; x++) {
        ...
        uxSgx[i] =
            (uxSgx[i] * pmlX[x] - (dtRho0Sgx * dxudxnSgx[x] * ifftX[i])) *
            pmlX[x];
      }  // x
    }  // y
  }  // z
...
#pragma omp simd
      for (size_t x = 0; x < dimensionSizes.nx; x++) {
        ...
        uySgy[i] =
            (uySgy[i] * pmlY[y] - (dtRho0Sgy * dyudynSgy[y] * ifftY[i])) *
            pmlY[y];
      }  // x
    }  // y
  }  // z
...
#pragma omp simd
        for (size_t x = 0; x < dimensionSizes.nx; x++) {
          ...
          uzSgz[i] =
              (uzSgz[i] * pmlZ[z] - (dtRho0Sgz * dzudznSgz[z] * ifftZ[i])) *
              pmlZ[z];
        }  // x
      }  // y
    }  // z
...
void KSpaceFirstOrderSolver::computeShiftedVelocity() {
  ...
  const FloatComplex* zShiftNegR =
      getComplexData(MI::kZShiftNegR, simulationDimension == SD::k3D);
...
void KSpaceFirstOrderSolver::computeVelocityGradient() {
  ...
  const FloatComplex* ddzKShiftNeg =
      getComplexData(MI::kDdzKShiftNeg, simulationDimension == SD::k3D);

  const float* kappa = getRealData(MI::kKappa);

  FloatComplex* tempFftX = getComplexData(MI::kTempFftwX);
  FloatComplex* tempFftY = getComplexData(MI::kTempFftwY);
  FloatComplex* tempFftZ =
      getComplexData(MI::kTempFftwZ, simulationDimension == SD::k3D);
...
#pragma omp simd
  ...
  if (mParameters.getNonUniformGridFlag() != 0) {
    ...
    const float* duzdzn =
        getRealData(MI::kDzudzn, simulationDimension == SD::k3D);
...
#pragma omp simd
  ...
  getTempFftwX().computeC2RFft1DX(getTemp1FftwRealND());
  getTemp1FftwRealND().computeInverseR2RFft1DY(TK::kDct2,
                                               getRealMatrix(MI::kDuxdx));

  //------------------------------------------------------------------------------------------------------------------//
  // duydy = dtt1D(real(ifft(kappa .* (...
  //                      bsxfun(@times, ddy_k_hahs, fft(dtt1D(uy_sgy, DST4, 2),
  //                      [], 1)) + ... fft(dtt1D(bsxfun(@times, 1./y_vec_sg,
  //                      uy_sgy), DCT4, 2), [], 1) ...
  //                      ), [], 1)), DCT2, 2) ./ M;

  // fft(dtt1D(uy_sgy, DST4, 2), [], 1))
  getTemp1FftwRealND().computeForwardR2RFft1DY(TK::kDst4,
                                               getRealMatrix(MI::kUySgy));
  getTempFftwX().computeR2CFft1DX(getTemp1FftwRealND());
...
// tempFftwX() = kappa .* (bsxfun(@times, ddy_k_hahs, tempFftwX()) +
// tempFftwY())
#pragma omp parallel for schedule(static)
  for (size_t y = 0; y < reducedDimensionSizes.ny; y++) {
#pragma omp simd
    for (size_t x = 0; x < reducedDimensionSizes.nx; x++) {
      ...
      tempFftX[i] =
          divider * kappa[i] * (ddyKHahs[y] * tempFftX[i] + tempFftY[i]);
    }  // x
  }  // y

  getTempFftwX().computeC2RFft1DX(getTemp1FftwRealND());
  getTemp1FftwRealND().computeInverseR2RFft1DY(TK::kDct2,
                                               getRealMatrix(MI::kDuydy));
...
/**
 * Calculate new values of acoustic density for nonlinear case (rhoX, rhoy and
 * rhoZ).
 */
template <SD simulationDimension, bool rho0ScalarFlag>
void KSpaceFirstOrderSolver::computeDensityNonliner() {
  ...
  const float rho0Scalar =
      (rho0ScalarFlag) ? mParameters.getRho0Scalar() : 0.0f;
...
/**
 * Calculate new values of acoustic density for linear case (rhoX, rhoy and
 * rhoZ).
 */
template <SD simulationDimension, bool rho0ScalarFlag>
void KSpaceFirstOrderSolver::computeDensityLinear() {
  ...
  const float dtRho0Scalar =
      (rho0ScalarFlag) ? dt * mParameters.getRho0Scalar() : 0.0f;
  const float* rho0Matrix = (rho0ScalarFlag) ? nullptr : getRealData(MI::kRho0);
...
#pragma omp simd
      for (size_t x = 0; x < dimensionSizes.nx; x++) {
        ...
        const float dtRho0 =
            (rho0ScalarFlag) ? dtRho0Scalar : dt * rho0Matrix[i];
...
void KSpaceFirstOrderSolver::computePressure() {
  if (mParameters.getNonLinearFlag()) {  // Nonlinear propagation
    switch (mParameters.getAbsorbingFlag()) {
      case Parameters::AbsorptionType::kLossless: {
        sumPressureTermsNonlinearLossless<simulationDimension, rho0ScalarFlag,
                                          bOnAScalarFlag, c0ScalarFlag>();
        break;
      }
      case Parameters::AbsorptionType::kPowerLaw: {
        computePressureNonlinearPowerLaw<simulationDimension, rho0ScalarFlag,
                                         bOnAScalarFlag, c0ScalarFlag,
                                         alphaCoefScalarFlag>();
        break;
      }
      case Parameters::AbsorptionType::kStokes: {
        sumPressureTermsNonlinearStokes<simulationDimension, rho0ScalarFlag,
                                        bOnAScalarFlag, c0ScalarFlag,
                                        alphaCoefScalarFlag>();
        break;
      }
    }
  } else {  // Linear propagation
    switch (mParameters.getAbsorbingFlag()) {
      case Parameters::AbsorptionType::kLossless: {
      ...
      case Parameters::AbsorptionType::kPowerLaw: {
        computePressureLinearPowerLaw<simulationDimension, rho0ScalarFlag,
                                      c0ScalarFlag, alphaCoefScalarFlag>();
        break;
      }
      case Parameters::AbsorptionType::kStokes: {
        sumPressureTermsLinearStokes<simulationDimension, rho0ScalarFlag,
                                     c0ScalarFlag, alphaCoefScalarFlag>();
        break;
      }
    }
...
void KSpaceFirstOrderSolver::sumPressureTermsNonlinearLossless() {
  ...
  const float bOnAScalar =
      (bOnAScalarFlag) ? mParameters.getBOnAScalar() : 0.0f;
...
#pragma omp parallel for simd schedule(simd : static)           \
    aligned(rhoX, rhoY, rhoZ, c2Matrix, bOnAMatrix, rho0Matrix, \
                p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    ...
    p[i] =
        c2 * (sumDensity + (bOnA * (sumDensity * sumDensity) / (2.0f * rho0)));
  }
...
void KSpaceFirstOrderSolver::computePressureNonlinearPowerLaw() {
  ...
  computePressureTermsNonlinearPowerLaw<simulationDimension, rho0ScalarFlag,
                                        bOnAScalarFlag>(
  ...
  sumPressureTermsNonlinearPowerLaw<c0ScalarFlag, alphaCoefScalarFlag>(
      absorbTauTerm, absorbEtaTerm, nonlinearTerm);
}  // end of computePressureNonlinearPowerLaw
//----------------------------------------------------------------------------------------------------------------------

/**
 * Sum sub-terms to calculate new pressure with stokes absorption in nonlinear
 * case.
 */
template <SD simulationDimension, bool rho0ScalarFlag, bool bOnAScalarFlag,
          bool c0ScalarFlag, bool absorbTauScalarFlag>
void KSpaceFirstOrderSolver::sumPressureTermsNonlinearStokes() {
  ...
  const float absorbTauScalar =
      (absorbTauScalarFlag) ? mParameters.getAbsorbTauScalar() : 0.0f;
  const float* absorbTauMatrix =
      (absorbTauScalarFlag) ? nullptr : getRealData(MI::kAbsorbTau);

  float* p = getRealData(MI::kP);

#pragma omp parallel for simd schedule(simd : static)                    \
    aligned(rhoX, rhoY, rhoZ, duxdx, duydy, duzdz, c2Matrix, rho0Matrix, \
                bOnAMatrix, absorbTauMatrix, p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float c2 = (c0ScalarFlag) ? c2Scalar : c2Matrix[i];
    const float rho0 = (rho0ScalarFlag) ? rho0Scalar : rho0Matrix[i];
    const float bOnA = (bOnAScalarFlag) ? bOnAScalar : bOnAMatrix[i];
    const float absorbTau =
        (absorbTauScalarFlag) ? absorbTauScalar : absorbTauMatrix[i];
...
#pragma omp parallel for simd schedule(simd : static) \
    aligned(rhoX, rhoY, rhoZ, c2Matrix, p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float c2 = (c0ScalarFlag) ? c2Scalar : c2Matrix[i];
...
void KSpaceFirstOrderSolver::computePressureLinearPowerLaw() {
  ...
  computePressureTermsLinearPowerLaw<simulationDimension, rho0ScalarFlag>(
      densitySum, velocityGradientTerm);
  ...
  sumPressureTermsLinear<c0ScalarFlag, alphaCoefScalarFlag>(
      absorbTauTerm, absorbEtaTerm, densitySum);
}  // end of computePressureLinearPowerLaw
//----------------------------------------------------------------------------------------------------------------------

/**
 * Sum sub-terms to calculate new pressure with stokes absorption in linear
 * case.
 */
template <SD simulationDimension, bool rho0ScalarFlag, bool c0ScalarFlag,
...
#pragma omp parallel for simd schedule(simd : static)                    \
    aligned(rhoX, rhoY, rhoZ, duxdx, duydy, duzdz, c2Matrix, rho0Matrix, \
                absorbTauMatrix, p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float c2 = (c0ScalarFlag) ? c2Scalar : c2Matrix[i];
    const float rho0 = (rho0ScalarFlag) ? rho0Scalar : rho0Matrix[i];
    const float absorbTau =
...
/**
 * Calculate three temporary sums in the new pressure formula for non-linear
 * power law absorbing case.
 */
template <SD simulationDimension, bool rho0ScalarFlag, bool bOnAScalarFlag>
void KSpaceFirstOrderSolver::computePressureTermsNonlinearPowerLaw(
    RealMatrix& densitySum, RealMatrix& nonlinearTerm,
...
#pragma omp parallel for simd schedule(simd : static)                      \
    aligned(rhoX, rhoY, rhoZ, duxdx, duydy, duzdz, bOnAMatrix, rho0Matrix, \
                pDensitySum, pNonlinearTerm,                               \
                pVelocityGradientSum : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float rhoSum = (simulationDimension == SD::k3D)
                             ? (rhoX[i] + rhoY[i] + rhoZ[i])
                             : (rhoX[i] + rhoY[i]);
...
/**
 * Calculate two temporary sums in the new pressure formula, linear absorbing
 * case.
 */
template <SD simulationDimension, bool rho0ScalarFlag>
void KSpaceFirstOrderSolver::computePressureTermsLinearPowerLaw(
    RealMatrix& densitySum, RealMatrix& velocityGradientSum) {
...
#pragma omp parallel for simd schedule(simd : static) \
    aligned(rhoX, rhoY, rhoZ, pDensitySum : kDataAlignment)
  for (size_t i = 0; i < size; i++) {
    pDensitySum[i] = (simulationDimension == SD::k3D)
                         ? (rhoX[i] + rhoY[i] + rhoZ[i])
                         : (rhoX[i] + rhoY[i]);
  }

#pragma omp parallel for simd schedule(simd : static) \
    aligned(duxdx, duydy, duzdz, rho0Matrix,          \
                pVelocityGradientSum : kDataAlignment)
  for (size_t i = 0; i < size; i++) {
    const float rho0 = (rho0ScalarFlag) ? rho0Scalar : rho0Matrix[i];
    const float duSum = (simulationDimension == SD::k3D)
 ...
 */
void KSpaceFirstOrderSolver::computePowerLawAbsorbtionTerm(
    FftwComplexMatrix& fftPart1, FftwComplexMatrix& fftPart2) {
...
/**
 * Sum sub-terms after FFTs to calculate new pressure in the non-linear power
 * law absorption case.
 */
template <bool c0ScalarFlag, bool tauAndEtaScalarFlag>
void KSpaceFirstOrderSolver::sumPressureTermsNonlinearPowerLaw(
    const RealMatrix& absorbTauTerm, const RealMatrix& absorbEtaTerm,
  ...
  const float absorbTauScalar =
      (tauAndEtaScalarFlag) ? mParameters.getAbsorbTauScalar() : 0.0f;
  const float* absorbTauMatrix =
      (tauAndEtaScalarFlag) ? nullptr : getRealData(MI::kAbsorbTau);

  const float absorbEtaScalar =
      (tauAndEtaScalarFlag) ? mParameters.getAbsorbEtaScalar() : 0.0f;
  const float* absorbEtaMatrix =
      (tauAndEtaScalarFlag) ? nullptr : getRealData(MI::kAbsorbEta);
...
#pragma omp parallel for simd schedule(simd : static)                   \
    aligned(c2Matrix, absorbTauMatrix, absorbEtaMatrix, pAbsorbTauTerm, \
                pAbsorbEtaTerm, bOnA, p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float c2 = (c0ScalarFlag) ? c2Scalar : c2Matrix[i];
    const float absorbTau =
        (tauAndEtaScalarFlag) ? absorbTauScalar : absorbTauMatrix[i];
    const float absorbEta =
        (tauAndEtaScalarFlag) ? absorbEtaScalar : absorbEtaMatrix[i];

    p[i] = c2 * (bOnA[i] + (divider * ((pAbsorbTauTerm[i] * absorbTau) -
                                       (pAbsorbEtaTerm[i] * absorbEta))));
  }
...
#pragma omp parallel for simd schedule(simd : static)                   \
    aligned(c2Matrix, absorbTauMatrix, absorbEtaMatrix, pAbsorbTauTerm, \
                pAbsorbEtaTerm, pDenistySum, p : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float c2 = (c0ScalarFlag) ? c2Scalar : c2Matrix[i];
    const float absorbTau =
        (tauAndEtaScalarFlag) ? absorbTauScalar : absorbTauMatrix[i];
    ...
    p[i] =
        c2 * (pDenistySum[i] + (divider * ((pAbsorbTauTerm[i] * absorbTau) -
                                           (pAbsorbEtaTerm[i] * absorbEta))));
  }
...
#pragma omp parallel for schedule(static) if (sourceSize > 16384)
      ...
      case Parameters::SourceMode::kAdditive: {  // temp matrix for additive
                                                 // source
        // Shortcut for transform kind.
        using TK = FftwRealMatrix::TransformKind;
        ...
        const size_t nElementsFull =
            mParameters.getFullDimensionSizes().nElements();
        const size_t nElementsReduced =
            mParameters.getReducedDimensionSizes().nElements();
        const float divider = (mParameters.isSimulationAS())
                                  ? 1.0f / float(nElementsFull * 2)
...
#pragma omp parallel for simd schedule(simd : static)
        ...
        if (mParameters
                .isSimulationAS()) {  // Axisymmetric medium, WSWA symmetry:
                                      // dtt1D(real(ifft(source_mat), [], 1)),
                                      // DCT2, 2)
          // This holds pScaledSource
          fftMatrix.computeC2RFft1DX(getTemp1FftwRealND());
          getTemp1FftwRealND().computeR2RFft1DY(TK::kDct2);
        } else {  // Normal medium: ifftn(source_mat)
...
void KSpaceFirstOrderSolver::computeVelocitySourceTerm(
    RealMatrix& velocityMatrix, const RealMatrix& velocitySourceInput,
...
#pragma omp parallel for schedule(static)
      ...
      // Forward transform
      if (mParameters.isSimulationAS()) {  // Axisymmetric medium, WSWA
                                           // symmetry: fft(dtt1D(source_mat,
                                           // DCT3, 2), [], 1) for x-source
        //                                     fft(dtt1D(source_mat, DST4, 2),
        //                                     [], 1) for y-source
        // temp1 matrix holds pScaledSource
        if (&velocityMatrix == &getRealMatrix(MI::kUxSgx)) {  // x-source
          getTemp1FftwRealND().computeR2RFft1DY(TK::kDct3);
        }
        if (&velocityMatrix == &getRealMatrix(MI::kUySgy)) {  // y - source
...
#pragma omp parallel for simd schedule(simd : static)
      ...
      if (mParameters
              .isSimulationAS()) {  // Axisymmetric medium, WSWA symmetry:
                                    // dtt1D(real(ifft(source_mat), [], 1)),
                                    // DCT2, 2) for x-source
        //                                     dtt1D(real(ifft(source_mat), [],
        //                                     1)), DST4, 2) for y-source
        fftMatrix.computeC2RFft1DX(getTemp1FftwRealND());
...
void KSpaceFirstOrderSolver::addInitialPressureSource() {
  ...
  getRealMatrix(MI::kP).copyData(
      getRealMatrix(MI::kInitialPressureSourceInput));

#pragma omp parallel for simd schedule(simd : static)
  for (size_t i = 0; i < nElements; i++) {
    const float tmp =
        sourceInput[i] /
        (dimScalingFactor * ((c0ScalarFlag) ? c2Scalar : c2Matrix[i]));
  ...
  if (mParameters
          .getNonUniformGridFlag()) {  // Non-uniform grid, homogeneous case,
...
void KSpaceFirstOrderSolver::computeInitialVelocityUniform() {
  ...
  const float dtRho0SgxScalar =
      (rho0ScalarFlag) ? 0.5f * mParameters.getDtRho0SgxScalar() : 0.0f;
  const float dtRho0SgyScalar =
      (rho0ScalarFlag) ? 0.5f * mParameters.getDtRho0SgyScalar() : 0.0f;
...
// x and y dimensions
#pragma omp parallel for simd schedule(simd : static)                  \
    aligned(dtRho0SgxMatrix, dtRho0SgyMatrix, dpdxSgx, dpdySgy, uxSgx, \
                uySgy : kDataAlignment)
  for (size_t i = 0; i < nElements; i++) {
    const float dtRho0Sgx =
        (rho0ScalarFlag) ? dtRho0SgxScalar : 0.5f * dtRho0SgxMatrix[i];
    const float dtRho0Sgy =
        (rho0ScalarFlag) ? dtRho0SgyScalar : 0.5f * dtRho0SgyMatrix[i];
  ...
  if (simulationDimension == SD::k3D) {
    const float dtRho0SgzScalar =
        (rho0ScalarFlag) ? 0.5f * mParameters.getDtRho0SgzScalar() : 0.0f;
    const float* dtRho0SgzMatrix =
        (rho0ScalarFlag) ? nullptr : getRealData(MI::kDtRho0Sgz);
...
#pragma omp parallel for simd schedule(simd : static) \
    aligned(dtRho0SgzMatrix, dpdzSgz, uzSgz : kDataAlignment)
    for (size_t i = 0; i < nElements; i++) {
      const float dtRho0Sgz =
          (rho0ScalarFlag) ? dtRho0SgzScalar : 0.5f * dtRho0SgzMatrix[i];
...
/**
 * Compute acoustic velocity for initial pressure problem, homogenous medium,
 * nonuniform grid.
 */
template <SD simulationDimension>
void KSpaceFirstOrderSolver::computeInitialVelocityHomogeneousNonuniform() {
  ...
  const float dtRho0Sgz = (simulationDimension == SD::k3D)
                              ? 0.5f * mParameters.getDtRho0SgzScalar()
                              : 0.0f;
...
void KSpaceFirstOrderSolver::generateKappa() {
  ...
  const float dz2Rec = (mParameters.isSimulation3D())
                           ? 1.0f / (mParameters.getDz() * mParameters.getDz())
                           : 0.0f;

  const float cRefDtPi =
      mParameters.getCRef() * mParameters.getDt() * float(M_PI);
...
void KSpaceFirstOrderSolver::generateKappaAS() {
  ...
  const float piDyM =
      float(M_PI) /
      (mParameters.getDy() * float(mParameters.getFullDimensionSizes().ny));
...
/**
 * Generate derivative operators for normal medium (dd{x,y,z}_k_shift_pos,
 * dd{x,y,z}_k_shift_neg)
 */
void KSpaceFirstOrderSolver::generateDerivativeOperators() {
  ...
  FloatComplex* ddzKShiftPos =
      getComplexData(MI::kDdzKShiftPos, mParameters.isSimulation3D());

  FloatComplex* ddxKShiftNeg = getComplexData(MI::kDdxKShiftNegR);
  FloatComplex* ddyKShiftNeg = getComplexData(MI::kDdyKShiftNeg);
  FloatComplex* ddzKShiftNeg =
      getComplexData(MI::kDdzKShiftNeg, mParameters.isSimulation3D());
  ...
  // Calculation done sequentially because the size of the arrays are small <
  // 512 Moreover, there's a bug in Intel compiler under windows generating
  // clobbered data. ddxKShiftPos, ddxKShiftPos
...
void KSpaceFirstOrderSolver::generateKappaAndNablas() {
  ...
  const float dzSqRec = (mParameters.isSimulation3D())
                            ? 1.0f / (mParameters.getDz() * mParameters.getDz())
                            : 0.0f;
...
void KSpaceFirstOrderSolver::generateTauAndEta() {
  if ((mParameters.getAlphaCoeffScalarFlag()) &&
      (mParameters.getC0ScalarFlag())) {  // Scalar values
    const float alphaPower = mParameters.getAlphaPower();
    const float tanPi2AlphaPower = tan(float(M_PI_2) * alphaPower);
    const float alphaNeperCoeff =
        (100.0f * pow(1.0e-6f / (2.0f * float(M_PI)), alphaPower)) /
        (20.0f * float(M_LOG10E));

    const float alphaCoeff2 =
        2.0f * mParameters.getAlphaCoeffScalar() * alphaNeperCoeff;

    mParameters.setAbsorbTauScalar(
        (-alphaCoeff2) * pow(mParameters.getC0Scalar(), alphaPower - 1.0f));
    mParameters.setAbsorbEtaScalar(alphaCoeff2 *
                                   pow(mParameters.getC0Scalar(), alphaPower) *
                                   tanPi2AlphaPower);
  } else {  // Matrix values
    const DimensionSizes& dimensionSizes = mParameters.getFullDimensionSizes();

    const bool alphaCoeffScalarFlag = mParameters.getAlphaCoeffScalarFlag();
    const float alphaCoeffScalar =
        (alphaCoeffScalarFlag) ? mParameters.getAlphaCoeffScalar() : 0.0f;
    // temp3 matrix holds alpha coeff matrix (used only once).
    const float* alphaCoeffMatrix =
        (alphaCoeffScalarFlag) ? nullptr : getRealData(MI::kTemp3RealND);
...
#pragma omp simd
        for (size_t x = 0; x < dimensionSizes.nx; x++) {
          ...
          const float alphaCoeff2 =
              2.0f * alphaNeperCoeff *
              ((alphaCoeffScalarFlag) ? alphaCoeffScalar : alphaCoeffMatrix[i]);

          absorbTau[i] =
              (-alphaCoeff2) *
              pow(((c0ScalarFlag) ? c0Scalar : cOMatrix[i]), alphaPower - 1.0f);
          absorbEta[i] =
              alphaCoeff2 *
              pow(((c0ScalarFlag) ? c0Scalar : cOMatrix[i]), alphaPower) *
              tanPi2AlphaPower;
        }  // x
      }  // y
    }  // z
...
/**
 * Generate shift variables for non-staggered velocity sampling (x_shift_neg_r,
 * y_shift_neg_r, z_shift_neg_r).
 */
void KSpaceFirstOrderSolver::generateNonStaggeredShiftVariables() {
  ...
  FloatComplex* zShiftNeg =
      getComplexData(MI::kZShiftNegR, mParameters.isSimulation3D());
  ...
  // Calculation done sequentially because the size of the arrays are small <
  // 512 Moreover, there's a bug in Intel compiler under windows generating
  // clobbered data. xShiftNeg - No SIMD due to Intel Compiler bug under Windows
...
void KSpaceFirstOrderSolver::generatePml() {
  ...
  // Calculate left value of PML exponent, for staggered use i + 0.5f, i shifted
  // by -1 (Matlab indexing).
  auto pmlLeft = [dt2](float i, float cRef, float pmlAlpha, float pmlSize) {
    return exp(-dt2 * pmlAlpha * cRef * pow((i - pmlSize) / (-pmlSize), 4));
  };  // end of pmlLeft.

  // Calculate right value of PML exponent, for staggered use i + 0.5f, i
  // shifted by +1 (Matlab indexing).
  ...
  for (size_t i = 0; i < pmlYSize; i++) {
    if (!mParameters.isSimulationAS()) {  // for axisymmetric code the PML is
...
void KSpaceFirstOrderSolver::generateC2() {
  if (!mParameters.getC0ScalarFlag()) {  // Matrix values
    const size_t nElements = mParameters.getFullDimensionSizes().nElements();

    float* c2 = getRealData(MI::kC2);

#pragma omp parallel for simd schedule(simd : static) \
    aligned(c2 : kDataAlignment)
    for (size_t i = 0; i < nElements; i++) {
      c2[i] = c2[i] * c2[i];
    }
  }  // matrix
...
inline size_t KSpaceFirstOrderSolver::get1DIndex(
    const size_t z, const size_t y, const size_t x,
