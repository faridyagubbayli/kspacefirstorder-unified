 ...
 *
 * @brief     The header file of the common ancestor of all matrix classes. A
 * pure abstract class.
 *
 ...
 *
 * @details Abstract base class. The common ancestor defining the common
 * interface and allowing derived classes to be allocated, freed and loaded from
 * the file using the Matrix container. The I/O is done via HDF5 files.
 */
class BaseMatrix {
 public:
  /// Default constructor.
   ...
   */
  virtual void readData(Hdf5File& file, const MatrixName& matrixName) = 0;
  /**
